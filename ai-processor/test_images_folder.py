"""
Script para testar o reconhecimento de placas em múltiplas imagens de uma pasta.
"""
...
def test_images_folder(folder_path: str):
    """
    Testa o reconhecimento de placas em todas as imagens de uma pasta.
    
    Args:
        folder_path: Caminho para a pasta contendo as imagens
    """
    # Criar reconhecedor
    ...
    print(f"\n{'='*80}")
    print(f"TESTE DE RECONHECIMENTO DE PLACAS")
    print(f"{'='*80}")
    ...
    output_file = folder / "recognition_results.json"
...
if __name__ == "__main__":
    ...
    test_images_folder(folder_path)
